    ...
    def first_image(self):
        ...
        if match:
            ...
            if "/media/" in url:
                ...
                # Fuzzy match: find file that starts with the target name
                ...
                # Ultimate fallback to original live website
...
class Talk(models.Model):
    ...
    # Stores the extracted YouTube video ID
    ...
    def save(self, *args, **kwargs):
        ...
        # Automatic YouTube ID extraction from external_link
        ...
        if self.external_link and self.video_id and not self.thumbnail:
            try:
                import requests
                ...
                thumb_path = f'talks/thumbnails/{self.video_id}.jpg'
    ...
    def get_absolute_url(self):
        return reverse('talk_detail', kwargs={'slug': self.slug})
...
class UploadedFile(models.Model):
    ...
    is_public = models.BooleanField(default=True, help_text="Show this file to website visitors")
...
class GatewayPage(models.Model):
    ...
    title = models.CharField(max_length=200)
    content = models.TextField(blank=True, help_text="Main content (can use basic HTML)")
    sidebar_content = models.TextField(blank=True, help_text="Optional sidebar content")
    featured_image = models.ImageField(upload_to='pages/%Y/%m/', blank=True, help_text="Featured image for this page")
    updated_at = models.DateTimeField(auto_now=True)
    show_in_navigation = models.BooleanField(default=True, help_text="Show this page in main navigation")
    navigation_order = models.IntegerField(default=0, help_text="Order in navigation (lower numbers first)")
    ...
    def get_absolute_url(self):
        ...
        return url_map.get(self.page_type, '/')
...
class SocialMediaProfile(models.Model):
    ...
    icon_name = models.CharField(max_length=50, blank=True, help_text="Font Awesome icon name (e.g., 'linkedin', 'envelope')")
    is_active = models.BooleanField(default=True)
    order = models.IntegerField(default=0)
    show_in_footer = models.BooleanField(default=True, help_text="Show in website footer")
    show_in_sidebar = models.BooleanField(default=False, help_text="Show in website sidebar")
    description = models.TextField(blank=True, help_text="Brief description of how Arun uses this platform")
...
class ContactMessage(models.Model):
    ...
    response_sent = models.BooleanField(default=False, help_text="Response has been sent")
...
class NewsletterSubscriber(models.Model):
    ...
    organization = models.CharField(max_length=200, blank=True)
    subscription_type = models.CharField(max_length=50, choices=SUBSCRIPTION_TYPES, default='general')
    subscribed_at = models.DateTimeField(auto_now_add=True)
    submitted_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    notes = models.TextField(blank=True, help_text="Optional notes about how they found the newsletter")
    is_active = models.BooleanField(default=True)
    last_sent = models.DateTimeField(blank=True, null=True, help_text="Last newsletter sent to this subscriber")
    confirmation_token = models.CharField(max_length=100, blank=True)
    is_confirmed = models.BooleanField(default=False, help_text="Email address has been confirmed")
...
class SiteSettings(models.Model):
    ...
    site_tagline = models.CharField(max_length=300, blank=True, default="A quiet space for thoughtful inquiry")
    ...
    enable_comments = models.BooleanField(default=False, help_text="Enable comments on articles")
    maintenance_mode = models.BooleanField(default=False, help_text="Put site in maintenance mode")
    default_theme_bucket_order = models.CharField(
        max_length=200,
